...
This code runs with  Python 3.7.13 and requires a list of packages. You can install them with `pip -r requirements.txt`.:
It is possible to run parts of the code using the newer, more readily Python version 3.9.25 - in this case, install the requirements with `pip -r requirements_python3.9.txt`. 
